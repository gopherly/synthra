...
// File represents a configuration source that loads data from a file or
// byte content.
...
// NewFile creates a new File source that loads configuration from the
// specified file path.
...
// NewFileContent creates a new File source that loads configuration from
// the provided byte slice.
// This is useful for loading configuration from embedded content or
...
// Load reads the configuration file and decodes its contents into a
// map[string]any.
