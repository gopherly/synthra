...
const (
	// DefaultFilePermissions represents the default file permissions for
	// dumped configuration files.
	// Files are created with read/write permissions for the owner and read
	// permissions for group and others (0644).
	DefaultFilePermissions = 0o644
)

// NewFile creates a new File dumper that writes configuration to the
// specified file path.
...
// Use this when you need more restrictive permissions (e.g., 0600 for
